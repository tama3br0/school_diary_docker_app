...
#   config.public_file_server.enabled = false #<= 本番環境では、NginxやApacheなどのウェブサーバーを使用して静的ファイルを提供することを推奨する。これにより、パフォーマンスが向上し、Railsアプリケーションの負荷が軽減される。しかし、このコメントアウトを外すと、CSSを失った。
...
#   config.action_controller.asset_host = "https://#{ENV['AWS_BUCKET']}.s3.ap-northeast-1.amazonaws.com"
  ...
  # config.active_job.queue_name_prefix = "school_diary_app_production"
